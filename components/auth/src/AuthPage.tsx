  ...
  return (
    <Base>
      ...
      <Nav>
        <NavItems stack grow>
          <NavItems>
            <LinkWithIcon href="https://github.com/dtc" target="_blank">
              <BiLogosGithub size={24} />
            </LinkWithIcon>
            <LinkWithIcon href="https://twitter.com/dtc" target="_blank">
        ...
        <NavItems hide>
          {t("general.image_by")} @ecell
          <Bullet />
          <a href="https://delhitechnicalcampus.ac.in/" target="_blank" rel="noreferrer">
